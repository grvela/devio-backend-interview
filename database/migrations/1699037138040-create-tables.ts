...
export class CreateTables1699037138040 implements MigrationInterface {
    name = 'CreateTables1699037138040'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('inProgress', 'finished')`);
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "amount" integer NOT NULL, "notes" character varying NOT NULL, "paymentType" character varying NOT NULL, "totalPrice" double precision NOT NULL, "clientName" character varying NOT NULL, "status" "public"."orders_status_enum" NOT NULL DEFAULT 'inProgress', "productId" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
